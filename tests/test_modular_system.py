...
from core.architecture import ModuleRegistry, BaseModule
from core.services import ServiceRegistry, BaseService, service_manager
from core.modules import (
    DesignSystemModule, AccountsModule, WalletsModule, 
    ProductsModule, OrdersModule, ExampleModule
)
from core.services import (
    UserService, WalletService, VendorService, ProductService,
    OrderService, DisputeService, MessagingService, SupportService
)
