...
class PGPTroubleshooter:
    ...
    def diagnose_key_issues(self, key_data):
        ...
        return {"issues": issues, "warnings": warnings, "can_proceed": can_proceed, "key_info": key_info}
    ...
    def get_compatibility_report(self):
        ...
        report = {
            ...
            "supported_formats": ["ASCII Armored (.asc)", "Binary (.gpg)", "Various line endings (Unix, Windows, Mac)"],
        }
        return report
