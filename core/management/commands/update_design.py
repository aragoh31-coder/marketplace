...
class Command(BaseCommand):
    ...
    def show_current_theme(self, design_system):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Current Theme: {theme_info['name']}")
        )
    ...
    def reset_theme(self, design_system):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS('Theme reset to default values successfully!')
            )
    ...
    def load_theme_file(self, design_system, theme_file_path):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f'Theme loaded from {theme_file_path} successfully!')
            )
    ...
    def update_color(self, design_system, color_name, color_value):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f'Color {color_name} updated to {color_value}')
            )
        except Exception as e:
    ...
    def update_spacing(self, design_system, spacing_name, spacing_value):
        ...
        try:
            ...
            design_system.update_theme(update_data)
            self.stdout.write(
                self.style.SUCCESS(f'Spacing {spacing_name} updated to {spacing_value}')
            )
        except Exception as e:
    ...
    def update_typography(self, design_system, typography_name, typography_value):
        ...
        try:
            update_data = {
                'typography': {
                    typography_name: typography_value
                }
            }
            
            design_system.update_theme(update_data)
            self.stdout.write(
                self.style.SUCCESS(f'Typography {typography_name} updated to {typography_value}')
            )
        except Exception as e:
