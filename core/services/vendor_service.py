...
class VendorService(BaseService):
    ...
    def create_vendor_profile(
        self, user_id: str, vendor_name: str, description: str = "", **kwargs
    ) -> Tuple[Any, bool, str]:
        ...
        try:
            ...
            with transaction.atomic():
                ...
                vendor = Vendor.objects.create(
                    user_id=user_id, vendor_name=vendor_name, description=description, **kwargs
                )
    ...
    def update_vendor_rating(
        self, vendor_user_id: str, user_id: str, rating: int, comment: str = ""
    ) -> Tuple[bool, str]:
        ...
        try:
            ...
            with transaction.atomic():
                ...
                rating_obj, created = VendorRating.objects.update_or_create(
                    vendor=vendor, user_id=user_id, defaults={"rating": rating, "comment": comment}
                )
    ...
    def get_vendor_ratings(self, vendor_user_id: str, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            ratings = (
                VendorRating.objects.filter(vendor__user_id=vendor_user_id)
                .select_related("user")
                .order_by("-id")[:limit]
            )
    ...
    def search_vendors(
        self, query: str = "", trust_level: str = None, is_approved: bool = None, limit: int = 50
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if query:
                ...
                queryset = queryset.filter(Q(vendor_name__icontains=query) | Q(description__icontains=query))
    ...
    def get_top_vendors(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            vendors = Vendor.objects.filter(is_approved=True, is_active=True).order_by("-rating", "-total_sales")[
                :limit
            ]
    ...
    def _log_vendor_action(self, vendor_user_id: str, action: str, admin_user_id: str, details: str = "") -> None:
