...
class ServiceManager:
    ...
    def call_service_with_fallback(self, service_name: str, operation: str, 
                                 fallback_service: str = None, *args, **kwargs) -> Any:
        """
                ...
                try:
                    if self.is_service_available(fallback_service):
                        ...
                        if hasattr(service, operation):
                            ...
                            raise ServiceError(f"Operation {operation} not found on fallback service {fallback_service}")
                    else:
