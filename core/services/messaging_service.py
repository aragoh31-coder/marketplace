...
class MessagingService(BaseService):
    ...
    def get_or_create_conversation(self, user1_id: str, user2_id: str, 
                                 order_id: str = None) -> Tuple[Any, bool]:
        ...
        try:
            ...
            existing_conversation = Conversation.objects.filter(
                models.Q(user1_id=user1_id, user2_id=user2_id) |
                models.Q(user1_id=user2_id, user2_id=user1_id)
            ).first()
    ...
    def send_message(self, conversation_id: str, sender_id: str, content: str, 
                    message_type: str = "text", **kwargs) -> Tuple[Any, bool, str]:
        ...
        try:
            ...
            with transaction.atomic():
                ...
                if conversation.last_message_id == message_id:
                    ...
                    last_message = Message.objects.filter(conversation_id=conversation_id).order_by('-created_at').first()
                    if last_message:
    ...
    def get_messaging_statistics(self, user_id: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            for i in range(12):
                ...
                month_messages = message_queryset.filter(
