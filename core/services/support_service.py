...
class SupportService(BaseService):
    ...
    def create_ticket(self, user_id: str, subject: str, description: str, 
                     category: str, priority: str = "medium", **kwargs) -> Tuple[Any, bool, str]:
    ...
    def add_ticket_response(self, ticket_id: str, user_id: str, content: str, 
                          is_internal: bool = False, **kwargs) -> Tuple[Any, bool, str]:
    ...
    def get_ticket_summary(self, ticket_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'started_at': ticket.started_at.isoformat() if hasattr(ticket, 'started_at') and ticket.started_at else None,
                'resolved_at': ticket.resolved_at.isoformat() if hasattr(ticket, 'resolved_at') and ticket.resolved_at else None,
                'closed_at': ticket.closed_at.isoformat() if hasattr(ticket, 'closed_at') and ticket.closed_at else None,
                'last_response_at': ticket.last_response_at.isoformat() if hasattr(ticket, 'last_response_at') and ticket.last_response_at else None
            }
    ...
    def _log_ticket_status_change(self, ticket_id: str, old_status: str, new_status: str, 
