...
class UserService(BaseService):
    ...
    def authenticate_user(self, username: str, password: str, ip_address: str = None) -> Tuple[Optional[User], bool, str]:
    ...
    def log_login_attempt(self, user: User, ip_address: str = None, success: bool = True, method: str = "password") -> None:
