...
def theme_colors_display():
    ...
    return {
        ...
        'theme_name': design_system.theme['name']
    }
...
def theme_text_gradient(color1, color2, direction='135deg'):
    ...
    return mark_safe(f'style="background: linear-gradient({direction}, {c1} 0%, {c2} 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"')