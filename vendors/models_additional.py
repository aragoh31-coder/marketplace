...
class VendorBond(models.Model):
    ...
    bond_amount = models.DecimalField(max_digits=16, decimal_places=8, validators=[MinValueValidator(Decimal("0.01"))])
...
class AdminSecurityLog(models.Model):
    ...
    target_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="targeted_by_admin"
    )
    ...
    reviewed_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="reviewed_security_logs"
    )
